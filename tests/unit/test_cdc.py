...
class ChangeDataCaptureTest(unittest.TestCase):
	...
	def test_change_data_capture(self, make_request):
		...
		self.assertEqual(1, len(cdc_response.Customer))
		self.assertEqual(2, len(cdc_response.Invoice))
	...
	def test_change_data_capture_with_timestamp(self, make_request):
		...
		self.assertEqual(1, len(cdc_response_with_datetime.Customer))
		self.assertEqual(2, len(cdc_response_with_datetime.Invoice))
